...
INSERT INTO `tourplan` (`tourplanCode`, `tourPlan1`, `tourPlan2`, `tourPlan3`, `tourCode`) VALUES
(1, '15h00 Xe và HDV Đà Nẵng Open Tour đón khách tại điểm hẹn, khởi hành đi tham quan khu du lịch cáp treo Bà Nà với độ cao 1487 mét so với mực nước biển.', '16h00 Qúy khách đến nơi, nhận phòng khách sạn, di chuyển đến Ga Tóc Tiên. Đoàn đi cáp treo đến đỉnh Bà Nà.\r\n\r\n16h30: Tự do vui chơi tại Fantasy park, khu vui chơi trong nhà với 105 trò chơi đa dạng như:  Tháp rơi tự do, Vòng Quay Tình Yêu, Phi Công Skiver, Đường Đua Lửa, Ngôi Nhà Ma. Hoặc quý khách có thể check in cùng các nghệ sĩ nổi tiếng tại Bảo Tàng Tượng Sáp ( vé tự túc). \r\n\r\nSau đó tự do tham quan khu Làng Pháp với lối kiến trúc cổ Gothic của thế kỷ 19. Xem hoàng hôn lãng mạn trên đỉnh Bà Nà núi chúa.', '18h00: Đoàn dùng cơm tối Buffet tại nhà hàng Beer Plaza, thưởng thức chưa trình nghệ thuật của các nghệ sĩ đến từ Châu Âu.\r\n\r\nQuý khách tự do ngắm cảnh đêm tại Bà Nà. Lưu trú tại Mercure Danang French Village Bana Hills', 1),
(2, 'Sáng: Quý khách dùng bữa sáng và chuẩn bị đồ tắm để chinh phục một trong những vịnh biển\r\nđẹp nhất thế giới - vịnh Nha Trang.\r\nChương trình tour du lịch Nha Trang 4 ngày 3 đêm sẽ đưa quý khách đến cảng Cầu Đá để lên\r\nthuyền khám phá biển đảo Nha Trang:\r\n● Hòn Một: Quý khách tham gia hoạt động lặn biển để chiêm ngưỡng những rạn san hô\r\ntuyệt đẹp và các loài cá rực rỡ sắc màu dưới lòng đại dương. Quý khách còn được thưởng\r\nthức “Tiệc Bar nổi” trên biển với rượu và trái cây cực kỳ thú vị.\r\nSau đó, quý khách ghé thăm KDL Con Sẻ Tre để vui chơi tắm biển trong làn nước trong xanh\r\nmát rượi, giải nhiệt cho mùa hè nóng bức. Quý khách tự do đi dạo ngắm cảnh, nghỉ ngơi và chụp\r\nảnh lưu niệm những khoảnh khắc đáng nhớ trong hành trình khám phá Nha Trang.\r\n', 'Trưa: Quý khách dùng cơm tại nhà hàng trên đảo.\r\nChiều: Quý khách nghỉ ngơi trên ghế dài và tận hưởng khung cảnh nên thơ của vùng biển Nha\r\nTrang. Quý khách cũng có thể tham gia các trò chơi thể thao vui nhộn như: Moto nước, dù\r\nlượn,...(chi phí tự túc)', 'Chiều: Về đến TPHCM, xe trả quý khách tại điểm đón ban đầu và kết thúc hành trình tour Nha\r\nTrang 4 ngày 3 đêm. Hẹn gặp lại quý khách tại những chương trình tour giá rẻ hấp dẫn sau!', 2);

INSERT INTO `tour_gallery` (`tour_gallaryCode`, `tourCode`, `gallery1`, `gallery2`, `gallery3`) VALUES
(1, 1, '../../asset/images/gallery/danang_1.jpg', '../../asset/images/gallery/danang_2.jpg', '../../asset/images/gallery/danang_3.jpg'),
(2, 2, '../../asset/images/gallery/nhatrang_1.jpg', '../../asset/images/gallery/nhatrang_2.jpg', '../../asset/images/gallery/nhatrang_3.jpg');