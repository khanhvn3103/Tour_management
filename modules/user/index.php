<section style="padding-top: 7rem">
    ...
    <div class="container">
        <div class="row" id="user-information">
            <div class="col-3 d-flex flex-column align-content-center align-items-center">
                ...
                <h5 class="primary-color mt-4 font-weight-bold"><?php echo $user['fullName']?></h5>
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="row">
                            <div class="col-12 mb-2">
                                <label class="col-sm-2 col-form-label"><?php echo $user['fullName']?></label>
                                <div class="col-sm-10">
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="<?php echo $user['identifyCard']?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-6 mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="<?php echo $user['dob']?>" readonly>
                                </div>
                            </div>
    ...
    <?php
            ...
            header("Location: /Tour_management/modules/authenticate/newlogin.php");
            exit();
        }
    ?>
</section>